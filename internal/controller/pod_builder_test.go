	...
	tests := []struct {
		...
		},
		{
			...
			validate: func(t *testing.T, pod *corev1.Pod) {
				...
				expectedTargetPath := downloader.DefaultScratchPath + "/disk.img"
		...
		},
		{
			...
			validate: func(t *testing.T, pod *corev1.Pod) {
				...
				var scratchMount, credsMount *corev1.VolumeMount
				...
				for i := range pod.Spec.Volumes {
					if pod.Spec.Volumes[i].Name == scratchDataVolumeName {
